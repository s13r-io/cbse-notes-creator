...
| Component | Weight |
|-----------|--------|
| Concepts with case studies | 35% |
| Data/statistics in tables | 25% |
| Exam prep | 25% |
...
### Common Pain Points
- **Economic indicators feel abstract — "what does this mean for my family?"**: Students memorize definitions but don't connect to real life: "GDP growing means more jobs, higher incomes. GDP falling means layoffs, lower wages." Always tie numbers to household impact. Happens in The Story of Village Palampur, Poverty as a Challenge chapters.
- **Factors of production — "physical vs human vs fixed capital, aren't they all money?"**: Students confuse categories. Decision rule: "Land = natural resource. Labor = human effort. Physical capital = tools and machines. Human capital = knowledge and skills." Always use the same concrete example. Happens in The Story of Village Palampur chapter.
- **Poverty line — "why is it a specific number?"**: Students think it's arbitrary. Explain the calorie basis: "2400 calories rural / 2100 calories urban per day. The poverty line is the income needed to buy that food." Connect to what a family actually buys. Happens in Poverty as a Challenge chapter.
...
## Exam Patterns — Economics (Social Science)
...
**Special question types**: Data interpretation, case study based
**Economics weightage**: ~20 marks out of 80

**Sample 1-mark**: What is the main production activity in Palampur? → Farming
**Sample 2-mark**: Differentiate between disguised unemployment and seasonal unemployment. → 1. Disguised unemployment: more people are employed than needed — removing them doesn't reduce output (common in farming). 2. Seasonal unemployment: people find work only in certain seasons (e.g., agricultural labourers during sowing/harvest).
**Sample 3-mark**: What are the factors of production? → 1. Land and natural resources. 2. Labour (physical and mental). 3. Physical capital (tools, machines, buildings) and working capital (raw materials, money). 4. Human capital (knowledge and enterprise).
**Sample 5-mark**: How is the poverty line estimated in India? → [Definition + calorie method: 2400 cal rural, 2100 cal urban + monetary equivalent + limitations of this method + current poverty statistics]
