...
| Component | Weight |
|-----------|--------|
| Descriptive content with spatial context | 35% |
| Map work and visual descriptions | 30% |
| Exam prep | 25% |
| Data/statistics in tables | 10% |

### Formatting Rules
- **Map descriptions**: Describe locations relative to known landmarks ("The Himalayas stretch from the Indus river in the west to the Brahmaputra in the east, forming an arc of about 2,400 km")
- **River systems**: Use flow descriptions (source → tributaries → confluence → mouth)
- **Climate data**: Tables with Region | Temperature Range | Rainfall | Season
- **Vegetation/Wildlife**: Classification tables with Zone | Climate | Flora | Fauna

### Target Word Count
6K-9K words

### Common Pain Points
- **Map locations without mental anchors — "where is the Deccan Plateau?"**: Students can't place features without a physical map. Use relative positioning: "The Himalayas run east-west at the top. The Deccan Plateau is the triangle below them, between two mountain ranges." Happens in India — Size and Location, Physical Features chapters.
- **Similar-named features confused — Western vs Eastern Ghats, Ganga vs Yamuna**: Students know the names but flip them. Decision rule: "West coast = Arabian Sea side. East coast = Bay of Bengal side." Happens in Physical Features of India, Drainage chapters.
- **River systems — memorized lists, no pattern**: Himalayan (perennial, snow-fed) vs Peninsular (seasonal, rain-fed). Students don't see the underlying pattern. Always compare: "Snow-fed = year-round. Rain-fed = depends on monsoon." Happens in Drainage chapter.
...
## Exam Patterns — Geography (Social Science)

**Paper structure**: Part of Social Science paper. Section A (20 MCQs × 1 mark), Section B (6 × 2 marks), Section C (7 × 3 marks), Section D (3 × 5 marks), Section E (3 case-based × 4 marks)
**Total**: 80 marks (shared across History, Geography, Economics, Political Science)
**Special question types**: Map work (locate rivers, mountains, cities), diagram-based, climate data interpretation
**Geography weightage**: ~20 marks out of 80

**Sample 1-mark**: Which is the longest river of India? → Ganga
**Sample 2-mark**: Name the two major divisions of the Himalayas on the basis of river valleys. → The two major divisions are: 1. The Himalayas between the Indus and Satluj rivers. 2. The Himalayas between the Satluj and Kosi rivers.
**Sample 3-mark**: Distinguish between Western Ghats and Eastern Ghats. → 1. Western Ghats are higher (avg 900-1600m) vs Eastern Ghats are lower (avg 600m). 2. Western Ghats are continuous; Eastern Ghats are discontinuous and broken by river valleys. 3. Western Ghats cause heavy orographic rainfall; Eastern Ghats lie in the rain shadow region.
**Sample 5-mark**: Describe the Northern Plains of India. → [Formation by alluvial deposits + 4 sub-divisions: Bhabar, Terai, Bhangar, Khadar — characteristics of each]
